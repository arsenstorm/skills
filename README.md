...
| review-pr | Reviews a pull request as the reviewer of record: drafts a verdict (approve, comment, request changes) with comments reserved for blocking faults and real questions, and posts only on approval. | [skills/review-pr/SKILL.md](skills/review-pr/SKILL.md) |
